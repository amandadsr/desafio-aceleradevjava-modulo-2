...
public class Motorista {
	...
	public static class MotoristaBuilder {
		...
		public MotoristaBuilder withPontos(int pontos) {
			if(pontos < 0) {
	    		throw new IllegalArgumentException("Os pontos nao pode ser negativos!");
	    	}
			this.pontos = pontos;
			return this;
		}
		...
		public Motorista build() {
			if (habilitacao.equals(null)) {
				throw new NullPointerException("Motorista nao tem Habilitacao!");
			}
			if(nome.equals(null)) {
	    		throw new NullPointerException("Nome do Motorista nao foi informado!");
	    	}
